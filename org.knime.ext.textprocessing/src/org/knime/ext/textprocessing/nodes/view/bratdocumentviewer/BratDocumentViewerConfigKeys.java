...
public class BratDocumentViewerConfigKeys {
    ...
    static final String DOC_TEXT = "documentText";

    static final String DOC_TITLE = "documentTitle";

    static final String DOC_TERM_IDS = "documentTermIds";

    static final String DOC_TERMS = "documentTerms";

    static final String DOC_TAGS = "documentTags";
